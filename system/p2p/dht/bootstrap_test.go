...
func Test_initInnerPeers(t *testing.T) {
	...
	h0str := h0.Addrs[0].String() + fmt.Sprintf("/p2p/%v", h0.ID.String())
	h1str := h1.Addrs[0].String() + fmt.Sprintf("/p2p/%v", h1.ID.String())
	h2str := h2.Addrs[0].String() + fmt.Sprintf("/p2p/%v", h2.ID.String())
	h3str := h3.Addrs[0].String() + fmt.Sprintf("/p2p/%v", h3.ID.String())
	h4str := h4.Addrs[0].String() + fmt.Sprintf("/p2p/%v", h4.ID.String())
	h7str := h7.Addrs[0].String() + fmt.Sprintf("/p2p/%v", h7.ID.String())
